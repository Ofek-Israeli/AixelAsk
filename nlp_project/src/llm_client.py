"""LLM client using the OpenAI-compatible ``/v1/chat/completions`` endpoint.

Works with any backend that exposes the OpenAI chat API (SGLang, vLLM, etc.).

Provides ``LlmClient`` with two calling conventions:
